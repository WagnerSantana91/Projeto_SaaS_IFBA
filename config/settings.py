...
SECRET_KEY = 'django-insecure-^!zdmc77d$e30yinw5eoi8-=w%zk37x#c4183z(^%k2tvs#zz@'
...
INSTALLED_APPS = [
    ...
    #Apps externos
    #Responsável por criar uma API RESTful para o sistema, facilitando a integração com outras aplicações e serviços.
    'rest_framework',
]
...
# Configuracoes de e-mail (pode sobrescrever via variaveis de ambiente)
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'no-reply@motelsaas.local')
